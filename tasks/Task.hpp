...
#ifndef MISC_ELISTAIR_TASK_TASK_HPP
#define MISC_ELISTAIR_TASK_TASK_HPP
...
namespace misc_elistair {
     ...
     * tasks/Task.cpp, and will be put in the misc_elistair namespace.
     */
    ...
    public:
         ...
         *                      configure state.
         */
        Task(std::string const& name = "misc_elistair::Task");
